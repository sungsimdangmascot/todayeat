...
//		탈퇴 신청 회원 목록
		model.addAttribute("withdrawList", memberService.findWithdrawMembers());
		
//		게시글 목록 - 최근 10개
		model.addAttribute("postList", postService.findRecentPostsForAdmin());
		
//		댓글 목록 - 최근 10개
		model.addAttribute("commentList", commentService.findRecentCommentsForAdmin());
...
//	관리자 댓글 강제 삭제
	...
	public String deleteComment(@PathVariable(name="commentId") int commentId) {
